...
namespace DVLD__Presentation_Tier.Forms.TestsAppointment.StreetTestForm
{
    public partial class frmStreetTestAppointment : Form
    {
        ...
        public frmStreetTestAppointment()
        {
            InitializeComponent();
        }

        public frmStreetTestAppointment(int LDLAppId)
        {
            InitializeComponent(LDLAppId);
            _LDLApplicationID = LDLAppId;
            _testTeypID = 3; //street test id in database.
        }

        private async void frmStreetTestAppointment_Load(object sender, EventArgs e)
        {
        ...
        private async void btnAddAppointment_Click(object sender, EventArgs e)
        {
            ...
            if (dgvAppointments?.CurrentRow != null)
            {
                ...
                {
                    frmSechduleStreetTest frmSechduleStreetTest = new frmSechduleStreetTest(appointmentID, ctrlSechduleStreetTest.enMode.Retake, this.ctrlLDLAwithApplicationInformation1.ApplicatFullName, _LDLApplicationID, _testTeypID, this.ctrlLDLAwithApplicationInformation1.licenseClassName, _appointmentsViewsList.Count);
                    frmSechduleStreetTest.ShowDialog();
                }
                else
                {
            ...
            {
                frmSechduleStreetTest frmSechduleStreetTest = new frmSechduleStreetTest(null, ctrlSechduleStreetTest.enMode.New, this.ctrlLDLAwithApplicationInformation1.ApplicatFullName, _LDLApplicationID, _testTeypID, this.ctrlLDLAwithApplicationInformation1.licenseClassName, _appointmentsViewsList.Count);
                frmSechduleStreetTest.ShowDialog();
            }
        ...
        private async void editeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmSechduleStreetTest frmSechduleStreetTest = new frmSechduleStreetTest(appointmentID, ctrlSechduleStreetTest.enMode.Edite, this.ctrlLDLAwithApplicationInformation1.ApplicatFullName, _LDLApplicationID, _testTeypID, this.ctrlLDLAwithApplicationInformation1.licenseClassName, _appointmentsViewsList.Count);
            frmSechduleStreetTest.ShowDialog();
            await _refreshDataInDGV();
        }
