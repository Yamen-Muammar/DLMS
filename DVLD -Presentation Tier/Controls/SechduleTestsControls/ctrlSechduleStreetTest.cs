...
{
    public partial class ctrlSechduleStreetTest : UserControl
    {
        ...
        private const int _testTypeID = 3; // test type id in database
        ...
        private async void ctrlSechduleStreetTest_Load(object sender, EventArgs e)
        {
            UILoad(_mode);
        ...
        private void UILoad(enMode mode)
        {
            ...
            if (_mode == enMode.Edite)
            {
                lblTitle.Text = "Edite Street Appointment";
                ctrlSechduleRetakeTest1.Enabled = false;
                ctrlSechduleRetakeTest1.Visible = false;
            ...
            if (_mode == enMode.Retake)
            {
                lblTitle.Text = "Retake Street Test";
